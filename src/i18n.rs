...
const EN: Strings = Strings {
    ...
    help_map_desc: "Map style (Liberty / OSM / CARTO / GSI / Aerial)",
    ...
    help_source_map_value: "Liberty / OSM / CARTO / GSI",
...
const JA: Strings = Strings {
    ...
    help_map_desc: "地図スタイル (Liberty / OSM / CARTO / 標準 / 航空)",
    help_source_rain_jp: "雨雲 (国内)",
    help_source_rain_global: "雨雲 (海外)",
    help_source_map: "地図",
    help_source_rain_jp_value: "気象庁ナウキャスト",
    help_source_rain_global_value: "RainViewer + Open-Meteo",
    help_source_map_value: "Liberty / OSM / CARTO / 国土地理院",
